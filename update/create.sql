CREATE TABLE `delivery_address` (
  ...
  `delivery_addressr_zip_code` varchar(150) COLLATE utf8_polish_ci NOT NULL,
  `delivery_addressr_city` varchar(150) COLLATE utf8_polish_ci NOT NULL,
  `delivery_addressr_contact` varchar(150) COLLATE utf8_polish_ci DEFAULT NULL,

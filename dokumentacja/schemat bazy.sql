...
CREATE TABLE IF NOT EXISTS `wd15`.`article` (
  ...
  `article_all_textile_amount` INT NULL,
  `article_first_textile_amount` INT NULL,
  `article_second_textile_amount` INT NULL,
...
CREATE TABLE IF NOT EXISTS `wd15`.`order` (
  ...
  `order_error` INT NOT NULL DEFAULT 0,
  `order_add_date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `wd15`.`order_has_textile` (
  ...
  `textile_pair` INT NULL,
  `textilepair_price_group` INT NULL,

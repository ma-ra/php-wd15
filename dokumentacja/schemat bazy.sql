...
CREATE INDEX `fk_textile_warehouse1_ix` ON `wd15`.`textile` (`textile_number` ASC);
...
CREATE TABLE IF NOT EXISTS `wd15`.`order` (
  ...
  `order_storno_date` DATETIME NULL,
  ...
  CONSTRAINT `fk_order_shopping1`
    FOREIGN KEY (`shopping1_shopping_id`)
    REFERENCES `wd15`.`shopping` (`shopping_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_order_shopping2`
    FOREIGN KEY (`shopping2_shopping_id`)
    REFERENCES `wd15`.`shopping` (`shopping_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_order_shopping1_idx` ON `wd15`.`order` (`shopping1_shopping_id` ASC);

CREATE INDEX `fk_order_shopping2_idx` ON `wd15`.`order` (`shopping2_shopping_id` ASC);
...
-- -----------------------------------------------------
-- Table `wd15`.`for_reuse`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wd15`.`for_reuse` (
  `for_reuse_id` INT NOT NULL AUTO_INCREMENT,
  `order_number` VARCHAR(50) NULL,
  `article_number` VARCHAR(50) NOT NULL,
  `textile1_number` VARCHAR(50) NOT NULL,
  `textile2_number` VARCHAR(50) NULL,

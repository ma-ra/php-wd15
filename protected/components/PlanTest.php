...
class Plan extends TCPDF {
	...
	function Header() {
		...
		$this->Rect(52, 5-1.5, 3, 3, 'DF', array(), array(0,0,0));
	...
	function DrawRow($strikethrough=0, $shoppingstatus=0) {
		...
		if ($strikethrough==1) {
			...
			$this->Rect(52, (($y+$this->GetY())/2)-1.5, 3, 3, 'DF', array(), array(0,0,0));
		} else {
			$this->Rect(52, (($y+$this->GetY())/2)-1.5, 3, 3, 'DF', array(), array(255,255,255));
		}
		$this->start=$this->GetY();
	...
	function Footer() {
		...
		$this->Rect(52, 205-1.5, 3, 3, 'DF', array(), array(0,0,0));
	}
}
?>
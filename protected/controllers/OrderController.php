				...
				try {
					if ($handle) {
						while (($buffer = fgets($handle, 4096)) !== false) {
							...
							if ($line[25]>1400 && $line[25]<6005) { #Jeden deseń na zamówieniu
							...
							if ($line[25]<=1400 || $line[25]>=6005) {
								...
								# zgłoś błąd, jeżeli numer pary jest >1400 || < 6005, a pojawi sie drugi deseń

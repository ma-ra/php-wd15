				...
				try {
					if ($handle) {
						while (($buffer = fgets($handle, 4096)) !== false) {
							...
							if ($line[25]>1500 && $line[25]<6003) { #Jeden deseń na zamówieniu
							...
							if ($line[25]<=1500 || $line[25]>=6003) {
								...
								# zgłoś błąd, jeżeli numer pary jest >1500 || < 6003, a pojawi sie drugi deseń
